...
class FilesController extends GetxController {
  ...
  calculateSize(List<FileSystemEntity> entities) {
    ...
    for (var i = 0; i < entities.length; i++) {
      if (entities[i].path.contains(".pdf") || entities[i].path.contains(".doc") || entities[i].path.contains(".txt") || entities[i].path.contains(".ppt") || entities[i].path.contains(".docx") || entities[i].path.contains(".pptx") || entities[i].path.contains(".xlsx") || entities[i].path.contains(".xls")) {
        documentSize += entities[i].statSync().size / 1000000;
      }
      if (entities[i].path.contains(".mp4") || entities[i].path.contains(".mkv") || entities[i].path.contains(".avi") || entities[i].path.contains(".flv") || entities[i].path.contains(".wmv") || entities[i].path.contains(".mov") || entities[i].path.contains(".3gp") || entities[i].path.contains(".webm")) {
        videoSize += entities[i].statSync().size / 1000000;
      }
      if (entities[i].path.contains(".jpg") || entities[i].path.contains(".jpeg") || entities[i].path.contains(".png") || entities[i].path.contains(".gif") || entities[i].path.contains(".bmp") || entities[i].path.contains(".webp")) {
        imageSize += (entities[i].statSync().size / 1000000);
      }
      if (entities[i].path.contains(".mp3") || entities[i].path.contains(".wav") || entities[i].path.contains(".aac") || entities[i].path.contains(".ogg") || entities[i].path.contains(".wma") || entities[i].path.contains(".flac") || entities[i].path.contains(".m4a")) {
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    try {
                      ...
                      File file = File('$folderPath/${fileName.text}.${fileExtension.text}');
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    try {
                      await FileManager.createFolder(controller.getCurrentPath, folderName.text).then((value) {
                        Navigator.pop(context);
